...
export function WorkspaceSwitcher({
  ...
  useEffect(() => {
    ...
    else queueMicrotask(() => setSearchQuery(""));
  }, [open]);
        ...
        <div className="absolute left-0 top-full z-50 mt-1 w-72 overflow-hidden rounded-lg border border-border bg-card shadow-2xl">
          ...
          <div className="flex items-center gap-2 border-b border-border px-3 py-2">
            ...
            <input
              ...
              onKeyDown={(e) => {
                ...
                if (e.key === "Enter" && filteredWorkspaces.length === 1)
                  handleSelect(filteredWorkspaces[0].path);
              }}
          ...
          <div className="max-h-56 overflow-y-auto py-1">
            {filteredWorkspaces.length === 0 && (
              <p className="px-3 py-3 text-center text-xs text-gray-600">
            ...
            {filteredWorkspaces.map((ws) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`truncate text-sm font-medium ${isActive ? "text-accent" : "text-gray-200"}`}
                    >
                      {ws.name}
                      {isActive && (
                  ...
                  {workspaces.length > 1 &&
                    (confirmRemoveId === ws.name ? (
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setConfirmRemoveId(ws.name);
                        }}
                        className="flex-shrink-0 text-[10px] text-gray-600 transition-colors hover:text-red-400"
          ...
          <div className="border-t border-border">
            {!showAdd ? (
              <button
                ...
                className="flex w-full items-center gap-1.5 px-3 py-2 text-left text-xs text-gray-500 transition-colors hover:bg-white/5 hover:text-accent"
              >
              ...
              <div className="space-y-2 px-3 py-2.5">
                <input
                  ...
                  className="w-full rounded border border-border bg-bg px-2 py-1.5 text-xs text-gray-200 placeholder-gray-600 focus:border-accent focus:outline-none"
                  autoFocus
                />
                ...
                <div className="flex gap-1.5">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 text-xs text-gray-500 transition-colors hover:text-gray-300"
                  >
                    Cancel
                  </button>
                </div>
